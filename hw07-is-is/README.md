...
где 49.2222.1720.1825.4025.00 - NSAP адрес маршрутизатора
...
Отказ любого одного маршрутизатора приводит к перестройке маршрутов, доступность всех работающих маршрутизаторов правктически не прерывается.
